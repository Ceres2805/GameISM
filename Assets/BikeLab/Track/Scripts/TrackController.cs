...
namespace VK.BikeLab
{
    ...
    public class TrackController : MonoBehaviour
    {
        ...
        public void update()
        {
            ...
            {
                speedText.text = "v " + (rb.linearVelocity.magnitude).ToString("0.0");
        ...
        public void fixedUpdate()
        {
            ...
            score.update(closest2, rb.linearVelocity.magnitude * 3.6f);
        ...
        {
            float v = vehicle.getRigidbody().linearVelocity.magnitude + 0.1f;
        ...
        {
            Rigidbody rb = vehicle.getRigidbody();
            float sqrV = rb.linearVelocity.sqrMagnitude;
            ...
            if (a > 0.1f && !dd.wait && rb.linearVelocity.magnitude < 0.1f && v > 1 && !redLight)
            {
