...
namespace VK.BikeLab
{
    ...
    public class ManualControl : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            info.currentVelocity = rb.linearVelocity.magnitude;
        }
        void Update()
        {
            bool rKey;
        ...
        private void setVelo()
        {
            ...
            Vector3 localV = transform.InverseTransformVector(rb.linearVelocity);
        ...
        private float getDumper()
        {
            ...
            float veloFactor = 1 / (rb.linearVelocity.magnitude + 1);
