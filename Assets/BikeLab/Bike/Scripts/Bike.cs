...
namespace VK.BikeLab
{
    ...
    public class Bike : MonoBehaviour, IVehicle
    {
        ...
        private void FixedUpdate()
        {
            ...
            float f = getSidewaysFriction(rb.linearVelocity.magnitude);
            //f = 1;
            ...
            if (rb.linearVelocity.magnitude < 0.1f && transform.up.y < 0.3f)
            {
                getup();
            }
        ...
        {
            float v = transform.InverseTransformVector(rb.linearVelocity).z;
        ...
        public void setAcceleration(float value)
        {
            ...
            float rpm = (rb.linearVelocity.magnitude + 1) * 30 / Mathf.PI / rearCollider.radius;
        ...
        private void updateSafeLeanIld()
        {
            ...
            float v = Mathf.Abs(transform.InverseTransformVector(rb.linearVelocity).z);
        ...
        private float deltaSteer(float targetLean)
        {
            ...
            float v = Mathf.Clamp(rb.linearVelocity.magnitude, 1, 100);
        ...
        public float damper()
        {
            ...
            float veloFactor = rb.linearVelocity.magnitude;// Mathf.Pow(rb.velocity.magnitude, 0.5f);
        ...
        public void getup(float h = 0.1f, float turn = 0)
        {
            ...
            {
                r.linearVelocity = transform.forward * 0;
