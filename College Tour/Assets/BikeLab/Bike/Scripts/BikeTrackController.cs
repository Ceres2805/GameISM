...
namespace VK.BikeLab
{
    ...
    public class BikeTrackController : TrackController
    {
        ...
        private void setSteer()
        {
            ...
            float v = Mathf.Max(transform.InverseTransformVector(rb.linearVelocity).z, 0);
            float time = 0.5f;
            float ds = v * time;
        ...
        private float getDumper()
        {
            ...
            float v = Mathf.Clamp(rb.linearVelocity.magnitude, 30, 30);
        ...
        private void setVelo()
        {
            ...
            Vector3 localV = rb.transform.InverseTransformVector(rb.linearVelocity);
            ...
            if (dToStop > 0)
            {
                float s = rb.linearVelocity.sqrMagnitude / 2 / maxBrakeA;
                if (s >= dToStop - 2)
                {
                    a = -rb.linearVelocity.sqrMagnitude / 2 / dToStop;
                }
            }
        ...
        private void updateIK()
        {
            ...
            iKControl.inputData.velocity = rb.linearVelocity.magnitude;
