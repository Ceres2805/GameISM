...
namespace VK.BikeLab.Segway
{
    ...
    public class Segway : MonoBehaviour, IVehicle
    {
        ...
        public void setSideIncline(float incline)
        {
            ...
            float omega = a / (rb.linearVelocity.magnitude + 1.0f);
            float v = getVelosity();
            if (v < -0.5f)
                omega = -omega;
        ...
        public float getVelosity()
        {
            ...
            float v = rb.linearVelocity.magnitude * Mathf.Sign(localV.z);
            return v;
        }
        ...
        private void getup()
        {
            ...
            rbL.linearVelocity = Vector3.zero;
            rbL.angularVelocity = Vector3.zero;

            rbR.linearVelocity = Vector3.zero;
        ...
        public float getTurnRadius()
        {
            ...
            float r = rb.linearVelocity.sqrMagnitude / (Mathf.Abs(a) + 0.01f);
            return r;
        }
